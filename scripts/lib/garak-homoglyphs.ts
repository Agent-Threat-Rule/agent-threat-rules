 ...
 */
export const GARAK_HOMOGLYPH_MAP: Readonly<Record<string, readonly string[]>> = Object.freeze({
  "!": ["ǃ"],
  "A": ["Α"],
  "B": ["Β"],
  "C": ["С"],
 ...
 */
export const GARAK_SMUGGLING_HOMOGLYPH_MAP: Readonly<Record<string, readonly string[]>> =
  Object.freeze({
    a: ["а"],
    c: ["с"],
    e: ["е"],
