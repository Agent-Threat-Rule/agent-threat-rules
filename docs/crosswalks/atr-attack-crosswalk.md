...
- ATR rules total: 734
- Rules carrying an enterprise ATT&CK id (`references.mitre_attack` Txxxx): 152
- Distinct enterprise ATT&CK techniques referenced: 59
- Rules carrying a MITRE ATLAS id (`references.mitre_atlas`): 734
- Distinct MITRE ATLAS techniques referenced: 40
- Rules carrying an OWASP Agentic id (`references.owasp_agentic`): 734
