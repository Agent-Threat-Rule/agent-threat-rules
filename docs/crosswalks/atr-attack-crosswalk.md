...
- ATR rules total: 738
- Rules carrying an enterprise ATT&CK id (`references.mitre_attack` Txxxx): 153
- Distinct enterprise ATT&CK techniques referenced: 59
- Rules carrying a MITRE ATLAS id (`references.mitre_atlas`): 738
- Distinct MITRE ATLAS techniques referenced: 40
- Rules carrying an OWASP Agentic id (`references.owasp_agentic`): 738
