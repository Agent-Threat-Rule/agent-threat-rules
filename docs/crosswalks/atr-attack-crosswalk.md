...
- ATR rules total: 729
- Rules carrying an enterprise ATT&CK id (`references.mitre_attack` Txxxx): 148
- Distinct enterprise ATT&CK techniques referenced: 57
- Rules carrying a MITRE ATLAS id (`references.mitre_atlas`): 729
- Distinct MITRE ATLAS techniques referenced: 40
- Rules carrying an OWASP Agentic id (`references.owasp_agentic`): 729
