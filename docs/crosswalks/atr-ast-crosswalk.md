...
Rules in corpus at generation time: **683**.
...
| AST03 | Over-Privileged Skills | 182 | ASI01 (83), ASI03 (82), ASI06 (31) |
...
| AST06 | Weak Isolation | 109 | ASI01 (67), ASI03 (37), ASI06 (17) |
| AST07 | Update Drift | 0 | - |
| AST08 | Poor Scanning | 0 | - |
| AST09 | No Governance | 30 | ASI03 (16), ASI01 (13), ASI02 (6) |
...
| context-exfiltration (109) | 109 | AST03 Over-Privileged Skills | Reading/exfiltrating data beyond the skill's need is over-privilege. |
...
| privilege-escalation (43) | 43 | AST03 Over-Privileged Skills | Privilege escalation is the direct consequence of over-privileged skills. |
...
| excessive-autonomy (30) | 30 | AST03 Over-Privileged Skills | Unbounded action authority is an over-privilege condition. |
