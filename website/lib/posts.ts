...
export const posts: BlogPost[] = [
  ...
  },
  {
    ...
    summary: {
      en: "The April 2026 Five Eyes guidance names third-party agent components — MCP servers, tools, skills — as a critical supply-chain risk, and gives no tool to check them. ATR scanned 96,096 across five registries: 1,302 flagged, three coordinated publishers — 552 of them from just two accounts.",
      zh: "2026 年 4 月 Five Eyes 指引點名第三方 agent 元件(MCP server、工具、skill)為關鍵供應鏈風險，卻沒給檢查的工具。ATR 掃了五個 registry 的 96,096 個：1,302 個有風險、三個協同發布者 —— 其中 552 個出自兩個帳號。",
    },
