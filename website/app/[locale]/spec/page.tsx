...
<p>Wild scan has no ground-truth labels and no per-item adjudication, so precision is undefined for it and no precision figure is reported. An earlier build published a &quot;precision floor&quot; of 751/1,302; both numbers were rule-hit counts, so the ratio measured nothing. Limitations are documented openly in <a href="https://github.com/Agent-Threat-Rule/agent-threat-rules/blob/main/LIMITATIONS.md" target="_blank" rel="noopener noreferrer">LIMITATIONS.md</a>.</p>
...
<p>Wild scan 沒有 ground truth label,也沒有逐筆判定,因此 precision 對它未定義,不報任何 precision 數字。先前版本曾公布 751/1,302 的「precision floor」,但分子分母都是規則命中數,那個比值量不到任何東西。限制公開記錄於 <a href="https://github.com/Agent-Threat-Rule/agent-threat-rules/blob/main/LIMITATIONS.md" target="_blank" rel="noopener noreferrer">LIMITATIONS.md</a>。</p>
