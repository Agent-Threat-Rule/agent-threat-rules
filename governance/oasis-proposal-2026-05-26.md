...
- **Measured performance** (figures as re-measured 2026-08-15 against 3.5.12): 96.6% recall on the 341-sample internal benchmark; 92.3% recall on NVIDIA garak's in-the-wild jailbreak corpus; 65.4% recall on an 850-sample PINT-format corpus (self-built, not Lakera's official PINT). Precision is deliberately not quoted: every one of these corpora is all-attack, so it has no negatives and any precision figure would be a script convention rather than a measurement.
